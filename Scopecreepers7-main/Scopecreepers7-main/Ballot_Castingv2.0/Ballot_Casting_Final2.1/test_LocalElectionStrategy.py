...
class TestLocalElectionStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.local1 = LocalElectionStrategy(self.election_registry)
    ...
    def test_verify(self):
        print('test_verify')
        self.assertTrue(self.local1.verify(self.vote3.vote()))
        self.assertFalse(self.local1.verify(self.vote1.vote()))
        self.assertFalse(self.local1.verify(self.vote2.vote()))
