...
class TestStateElectionStrategy(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print('setupClass')
    ...
    def setUp(self):
        ...
        self.local1 = StateElectionStrategy(self.election_registry)
    ...
    def test_verify(self):
        ...
        self.vote1.setposition('senator')
        self.vote1.setelection_type('state')
